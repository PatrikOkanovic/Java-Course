...
public class ArrayIndexedCollection<E> implements List<E> {
	...
	private static class ElementsGetterArray<T> implements ElementsGetter<T>  {
		 ...
		 * @param array
		 */
		private ElementsGetterArray(Object[] array, int size, long modificationCount, ArrayIndexedCollection<T> collection) {
			this.array = array;
			this.size = size;
	...
	public ElementsGetter<E> createElementsGetter() {
		return new ElementsGetterArray<E>(elements,size, modificationCount, this);
	}
